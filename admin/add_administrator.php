<?php
    ...
    if(isset($_POST["submit"])) {
        $a_email = $_POST["email"];
        $a_sel = "SELECT * FROM `administrator` WHERE `email` = '$a_email'";
        $a_sel_res = mysqli_query($db, $a_sel);
        if(mysqli_num_rows($a_sel_res)) {
            $a_error = "Email Already Exists";
        }
        else {
            ...
            $a_cnic = $_POST["cnic"];
            $a_gndr = $_POST["gndr"];
            $a_ins = "INSERT INTO `administrator`(`name`, `email`, `phone`, `pass`, `user_type`, `profile`, `CNIC`, `gender`) VALUES ('$a_name','$a_email','$a_phone','$a_pass',0,'$a_profile','$a_cnic','$a_gndr')";
            $a_result = mysqli_query($db, $a_ins);
            ?>
            <Script>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <?php if($_SESSION["mytype"] == 0) { ?> <a href="add_administrator.php" class="nav-item nav-link active"><i class="fas fa-file-invoice"></i>Add Administrator</a> <?php } ?>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <form action="#" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingText" placeholder="jhondoe" name="cnic">
