                                        ...
                                        <form action="final.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                <div class="bg-secondary  row rounded h-100 p-4">                                                    
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        <input type="file" name="finalexam">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <th scope="row">                                                            <td><a href="myresult3.php?ex=<?php echo $row["id"]; ?>"><button type="button" class="btn btn-outline-info">Give Results</button></a></td></th>                                                      
                                                    </tr>
                                        <?php
                                                }
                                            }
