<?php
    ...
    if(isset($_POST["submit"])) {
        ...
        if(mysqli_num_rows($t_sel_res)) {
            ...
            $t_gndr = $_POST["gndr"];
            $t_ins = "INSERT INTO `teachers`(`name`, `email`, `phone`, `pass`, `dob`, `gender`, `address`, `cnic`, `profile`) VALUES ('$t_name','$t_email','$t_phone','$t_pass','$t_dob','$t_gndr','$t_address','$t_cnic','$t_profile')";
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle"><img src="teachers/<?php echo $row[9]; ?>" style="height: 3vw;" alt=""></td>
