                                ...
                                <div class="row bg-secondary rounded h-100 p-4">
                                    <div class="text-center">
                                        <div id="MYIMG5" class="ms-auto me-auto" style="min-height: 10vw; max-width: 20vw; max-height: 20vw;">
                                            <img class="img-fluid" src="profile/<?php echo $admin_row[6]; ?>" alt="No Cover" style="max-height: 20vw;" />
                                        </div>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" value="<?php echo $admin_row[1]; ?>" name="name" id="floatingInput" placeholder="Teacher Name">
                                        <label for="floatingInput">Name</label>
                                    </div>
                                    <div class="col-md-6 form-floating mb-3">
                                        <input type="email" class="form-control" value="<?php echo $admin_row[2]; ?>" name="email" id="floatingInput" placeholder="Teacher Name">
                                    ...
                                    <div class="col-md-6 form-floating mb-3">
                                        <input type="number" class="form-control" value="<?php echo $admin_row[3]; ?>" name="phone" id="floatingInput" placeholder="Teacher Name">
                                        <label for="floatingInput">Phone</label>
                                    </div>
                                    <div class="col-md-6 form-floating mb-3">
                                        <input type="text" name="cnic" class="form-control" value="<?php echo $admin_row[7]; ?>" id="floatingPassword" placeholder="Dateof Birth">
                                        <label for="floatingPassword">CNIC</label>
                                    </div>     

                                    <div class="col-sm-12 form-floating d-flex justify-content-center">
                                        <button type="submit" name="edit1" class="btn btn-primary col-sm-3">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
