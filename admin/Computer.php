...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h1 class="text-center">Computer Science Results</h1>
                <div class="row g-4">                    
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    <div class="col-md-6 form-floating mb-3">
                                        <select id="classsci" class="form-control bg-dark" name="class">
                                            <option value="0">Select Class</option>
                                            <?php
                                                $sel = "SELECT * FROM `class`";
                                                $res = mysqli_query($db, $sel);
                    ...
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    <div class="col-md-6 form-floating mb-3">
                                        <select id="classmth" class="form-control bg-dark" name="class">
                                            <option value="0">Select Class</option>
                                            <?php
                                                $sel = "SELECT * FROM `class`";
                                                $res = mysqli_query($db, $sel);
    ...
    <script>        
        ...
        // Computer Science
        $('#classsci').on('change', function() {
            const id =$(this).find(":selected").val();
            $.ajax({
                url: "computer_sci.php",
                cache: false,
                type: "POST",
                data: {id : id},
                success: function(html){
        ...
        // Math
        $('#classmth').on('change', function() {
            const id =$(this).find(":selected").val();
            $.ajax({
                url: "computer_mth.php",
                cache: false,
                type: "POST",
                data: {id : id},
                success: function(html){
