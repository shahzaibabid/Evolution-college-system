    ...
    if(isset($_POST["submit"])) {
        ...
        while($row = mysqli_fetch_array($res_p)) {
            ...
            if($pid == 1) {
                ...
                $mid = "INSERT INTO `mid`(`UserId`, `eng`, `urdu`, `isl`, `math`, `phy`, `chem`, `obt`, `ttl`, `per`, `grade`, `status`) VALUES ('$id1', '$english', '$myurdu', '$myisl', '$sb2', '$sb3', '$sb1', '$obtained', '$totalmks', '$per', '$grade', '$examstatus')";
                ...
                $mid = "INSERT INTO `mid`(`UserId`, `eng`, `urdu`, `isl`, `phy`, `chem`, `zoology`, `botany`, `obt`, `ttl`, `per`, `grade`, `status`) VALUES ('$id1', '$english', '$myurdu', '$myisl', '$sb1', '$sb2', '$sb3', '$sb4', '$obtained', '$totalmks', '$per', '$grade', '$examstatus')";
                $midres = mysqli_query($db,$mid);
                ?>
                <script>
                    window.location.assign("./examination.php");
                ...
                $mid = "INSERT INTO `mid`(`UserId`, `eng`, `urdu`, `isl`, `math`, `phy`, `computer`, `obt`, `ttl`, `per`, `grade`, `status`) VALUES ('$id1', '$english', '$myurdu', '$myisl', '$sb1', '$sb2', '$sb3', '$obtained', '$totalmks', '$per', '$grade', '$examstatus')";
                $midres = mysqli_query($db,$mid);
                ?>
                <script>
                    window.location.assign("./examination.php");
                ...
                $mid = "INSERT INTO `mid`(`UserId`, `eng`, `urdu`, `isl`, `civic`, `psy`, `edu`, `obt`, `ttl`, `per`, `grade`, `status`) VALUES ('$id1', '$english', '$myurdu', '$myisl', '$sb1', '$sb2', '$sb3', '$obtained', '$totalmks', '$per', '$grade', '$examstatus')";
                $midres = mysqli_query($db,$mid);
                ?>
                <script>
                    window.location.assign("./examination.php");
                ...
                $mid = "INSERT INTO `mid`(`UserId`, `eng`, `urdu`, `isl`, `math`, `acc`, `economic`, `poc`, `obt`, `ttl`, `per`, `grade`, `status`) VALUES ('$id1', '$english', '$myurdu', '$myisl', '$sb1', '$sb2', '$sb3', '$sb4', '$obtained', '$totalmks', '$per', '$grade', '$examstatus')";
                $midres = mysqli_query($db,$mid);
                ?>
                <script>
                    window.location.assign("./examination.php");
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <div class="d-flex justify-content-between mb-4">
                                <?php                                
                                    ...
                                    $sel_class = "SELECT e.id,e.subject,e.program_id,s.name FROM `mid_exam` e  INNER JOIN `subjects` s ON s.id = e.subject WHERE e.id = $examid AND `result` = 'no'";
