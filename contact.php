    ...
    <div class="about-inner">
        <div class="wrapper">
            ...
            <ul class="breadcrumbs-custom-path">
                <h3>Contact Us</h3>
                <p>Our door is always open to solve your query.</p>
            </ul>
        </div>
    </div>
</section>
...
<section class="w3l-contacts-9-main">
    ...
    <div class="contacts-9"  id="contact">
        <div class="wrapper">
                <div class="top-map">
                    ...
                    <div class="cont-details">
                            <div class="map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3620.9065711513867!2d67.07122101447703!3d24.832868502479908!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33c6b03254785%3A0x1b2a58aef179afe2!2sAptech%20Defence%20Center!5e0!3m2!1sen!2s!4v1659370170772!5m2!1sen!2s" width="600" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>                        
                        </div>
            </div>
        </div>
    ...
    <div class="container mb-5 row">
        <div class="col-md-3">
            <h6>Address: Aptech DHA Phase-2</h6>
        </div>
        <div class="col-md-3">
            <h6>City: Karachi</h6>
        </div>
        <div class="col-md-3">
            <h6>Phone: +923323235615</h6>
        </div>
        <div class="col-md-3">
            <h6>Email: ECSacademy@gmail.com</h6>
        </div>
    </div>
    </center>
</section>
